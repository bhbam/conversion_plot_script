...
n = args.dataset
mass_bins_original = np.arange(3.6,15,0.4)
...
decay = "IMG_aToTauTau_Hadronic_tauDR0p4_mass_1p2To3p6_Gev_dataset_2_unbaised_unphysical_v2"
...
out_dir_plots = "plots_from_mass_m1p2To3p6_Gev_unbiased_unphysical_pq_to_pq/%s"%(subset)
...
file_str = "%s/IMG_aToTauTau_Hadronic_tauDR0p4_mass_below_1p2_Gev_dataset_2_unbaised_%s_train_unphysical_v2.parquet"%(out_dir,subset)
