...
outStr='/storage/local/data1/gpuscratch/bbbam/ParquetFiles_correctTrackerLayerHits_SecVtxInfoAdded/DYToTauTau_M-50_13TeV-powheg_pythia8/AODJets/DYToTauTau_M-50_13TeV-powheg_pythia8_95.parquet'
pqIn = pq.ParquetFile(outStr)
print(pqIn.metadata)
# print(pqIn.schema)
# X = pqIn.read_row_group(0, columns=['y','secVtx_jet_dR','secVtx_Pt','X_jet']).to_pydict()
X = pqIn.read_row_group(0, columns=['y','jetM','jetPt']).to_pydict()
print(X)
