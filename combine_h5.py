...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_data_path', default='/eos/uscms/store/user/bbbam/signals_jet_multi/IMG_HToAATo4Tau_Hadronic_signal_mass_14_GeV_with_jet_multi_h5_test/',
                        help='input data path')
    parser.add_argument('--output_data_path', default='/eos/uscms/store/user/bbbam/signals_jet_multi/IMG_HToAATo4Tau_Hadronic_signal_mass_14_GeV_with_jet_multi_test_combined_h5/',
                        help='output data path')
    parser.add_argument('--output_data_file', default='IMG_HToAATo4Tau_Hadronic_signal_mass_14_GeV_with_jet_mult.h5',
