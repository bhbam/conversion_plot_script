...
# Example dirName (switch between datasets)
dirName = '/eos/uscms/group/lpcml/rchudasa/MCGenerationRun3/HToAATo4Tau_hadronic_tauDecay_M3p7_Run3_2023/3p7_MLAnalyzer_miniAOD_bigProductionRe/250430_020739/0001'
...
def generate_condor_scripts(numScripts, output_directory):
    ...
    for i in range(numScripts):
        ...
        outputFile = "/eos/cms/store/group/lpcml/bbbam/condor_test/test_%d.parquet"%(i)
...
cd /uscms/home/bbbam/nobackup/conversion_plot_scripts/
echo $PWD
python /uscms/home/bbbam/nobackup/conversion_plot_scripts/Run_3_convert_root2h5_signal_jet.py -i %s -o %s
