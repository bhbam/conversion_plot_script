...
# file =glob.glob('/eos/uscms/store/user/bhbam/Run_3_IMG_mass_reg_unphy_m0To3p6/IMG_Tau_Hadronic_decay_mass_reg_m0To3p6_pt30To300_normalized_combined_unbiased/IMG_Tau_Hadronic_decay_massregssion_samples_m1p8To3p6_pt30To300_unbiased_normalized_train.h5')
file =glob.glob('/storage/local/data1/gpuscratch/bbbam/IMG_AToTau_Hadronic_massregssion_samples_m1p8To3p6_pt30To300_h5/IMG_AToTau_Hadronic_decay_massregssion_samples_m1p8To3p6_pt30To300_combined_original_train.h5')
# file =glob.glob('/storage/local/data1/gpuscratch/bbbam/IMG_Tau_Hadronic_decay_massregssion_samples_m1p8To3p6_pt30To300_h5/IMG_Tau_Hadronic_decay_massregssion_samples_m1p8To3p6_pt30To300_combined_original_valid.h5')
file_ = file[0]
...
plt.savefig(f"{out_dir}/A_mass_pt_plot.png", dpi=300, bbox_inches='tight')
plt.close()

plt.hist(np.squeeze(am), bins=mass_bins)
plt.xlabel(r'$\mathrm{A_{mass}}$ [GeV]')
# hep.cms.label(llabel="Simulation Preliminary", rlabel="13.6 TeV", loc=0, ax=ax)
plt.savefig(f"{out_dir}/A_mass_plot.png", dpi=300, bbox_inches='tight')
plt.close()
